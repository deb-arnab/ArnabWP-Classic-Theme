...
/**
 * Trait: Breadcrumbs Customizer Options
 *
 * Adds breadcrumb customization options to the WordPress Customizer.
 *
 * @package ArnabWP
 */
...
trait Breadcrumb_Options
{

	/**
	 * Registers breadcrumb-related customizer settings, sections, and controls.
	 *
	 * @param \WP_Customize_Manager $wp_customize The WordPress Customizer object.
	 *
	 * @return void
	 */
	public function add_breadcrumb_section($wp_customize)
	{
		...
		$wp_customize->add_setting('arnabwp_breadcrumb_separator', [
			'default'           => '>',
			'sanitize_callback' => [$this, 'sanitize_breadcrumb_separator'],
		]);
